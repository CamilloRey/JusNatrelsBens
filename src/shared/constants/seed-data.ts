...
export const SEED_PRODUCTS: Product[] = [
  ...
  { id: 'p2',  name: 'Hibiscus Fraises',             category: 'Jus',     price: 9.49,  formats: ['250ml','1L'],         desc: "Fusion rafraîchissante de fleurs d'hibiscus et fraises fraîches.", available: true, tag: 'Nouveau',   img: '/images-bens/produits/hibiscus-fraises-trio.png', color: '#e63946' },
  { id: 'p3',  name: 'Hibiscus Fraises Sans Sucre',  category: 'Jus',     price: 9.49,  formats: ['250ml','354ml','1L'], desc: 'Toute la saveur sans sucre ajouté.', available: true, tag: '', img: '/images-bens/produits/hibiscus-fraises-trio-sans-sucre.png', color: '#d62839' },
  { id: 'p4',  name: 'Gingembre Citron Sucré',       category: 'Jus',     price: 7.99,  formats: ['250ml','1L'],         desc: 'Piquant et acidulé, parfait pour chaque moment.', available: true, tag: '', img: '/images-bens/produits/gingembre-citron-sucre-trio.png', color: '#f4a261' },
  { id: 'p5',  name: 'Gingembre Citron Sans Sucre',  category: 'Jus',     price: 7.99,  formats: ['250ml','1L'],         desc: 'Bienfaits du gingembre et citron, zéro sucre ajouté.', available: true, tag: 'Populaire', img: '/images-bens/produits/gingembre-citron-trio.png', color: '#e9c46a' },
  { id: 'p6',  name: "Jus d'Ananas",                 category: 'Jus',     price: 8.49,  formats: ['250ml','354ml','1L'], desc: "Explosion tropicale de saveur d'ananas frais.", available: true, tag: '', img: '/images-bens/produits/ananas-trio.png', color: '#f4a261' },
  { id: 'p7',  name: 'Ananas Sucré',                 category: 'Jus',     price: 8.49,  formats: ['250ml','1L'],         desc: "La douceur tropicale de l'ananas.", available: true, tag: '', img: '/images-bens/produits/ananas-sucre-trio.png', color: '#e9c46a' },
  { id: 'p8',  name: 'Ananas Passion',               category: 'Jus',     price: 9.99,  formats: ['250ml','354ml','1L'], desc: 'Mélange exotique ananas et fruit de la passion.', available: true, tag: 'Nouveau', img: '/images-bens/produits/ananas-passion-trio.png', color: '#e76f51' },
  { id: 'p9',  name: 'Jus de Bleuets',               category: 'Jus',     price: 10.99, formats: ['1L'],                 desc: 'Source de fibres, riche en vitamine C et antioxydants.', available: true, tag: '', img: '/images-bens/produits-boutique/jus-bleuets-1L.jpg', color: '#457b9d' },
  { id: 'p10', name: 'Jus de Fraises',               category: 'Jus',     price: 8.99,  formats: ['250ml','1L'],         desc: 'Délicieux jus de fraises fraîches du Québec.', available: true, tag: '', img: '/images-bens/produits/jus-fraises-250ml.jpg', color: '#e63946' },
  { id: 'p11', name: 'Gingembre Bio',                category: 'Tisanes', price: 9.99,  formats: ['1L'],                 desc: 'Source de potassium, propriétés antibactériennes et antivirales.', available: true, tag: 'Populaire', img: '/images-bens/produits-boutique/jus-gingembre-bio-1L.jpg', color: '#bc6c25' },
];
