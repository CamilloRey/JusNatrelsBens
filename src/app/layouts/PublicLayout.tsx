      ...
      <header className={`public-header ${scrolled ? 'public-header-scrolled' : ''}`.trim()}>
        <div className="public-nav-wrap">
          ...
          <div className="public-tools">
            <LanguageSwitcher />
            <Link to={ROUTES.products} className="public-cart-btn" aria-label="Boutique">
      ...
      <footer className="public-footer">
        <div className="public-footer-grid">
          ...
          <div className="public-footer-brand-col">
            <span className="public-footer-brand-name">Les Jus Naturels</span>
            <p className="public-footer-text">
              {"Artisanal & Organique. Le meilleur de l'Afrique, pressé avec amour à Montréal."}
            </p>
            <div className="public-footer-socials">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="public-footer-social-btn public-footer-social-whatsapp"
                aria-label="WhatsApp"
                title="WhatsApp"
              >
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
          ...
          <div className="public-footer-card">
            ...
            <div className="public-footer-contact-row">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="#d4a853" className="public-footer-contact-icon">
